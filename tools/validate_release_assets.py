"""Static release-asset validation for the Geneformer V2-104M single-cell DIMER pipeline.
...
REPO_NAME = "geneformer-single-cell-pipeline"
NOTEBOOK_NAME = "geneformer_single_cell_colab.ipynb"
EXPECTED_PROFILE = "E2E"
EXPECTED_MODEL_ID = "ctheodoris/Geneformer"
...
EXPECTED_OUTPUTS = (
    "outputs/geneformer_single_cell_sample_dataset.csv",
    "outputs/geneformer_single_cell_embeddings.csv",
    "outputs/geneformer_single_cell_evaluation_report.json",
    "outputs/geneformer_single_cell_predictions.csv",
    "outputs/geneformer_single_cell_adapter",
    "outputs/geneformer_single_cell_result.json",
)
# Profile-specific code the notebook must exercise through the carried modules' public API.
CODE_MARKERS = (
    # Stage 4: dictionaries, dataset, validation, stratified split
    "USE_BYOD = False",
    ...
    # Stage 8: bounded fine-tuning with explicit hyperparameters
    "adapt_result = pipe.adapt(",
    "trainable_layers=TRAINABLE_LAYERS",
    "learning_rate=LEARNING_RATE",
    # Stage 9: held-out evaluation and report
    ...
    # Stage 10: new-cell inference through validate_inputs + classify
    ...
    # Stage 11: artifact export and fresh reload parity
...
MARKDOWN_MARKERS = (
    ...
    "in-silico perturbation, gene classification",
    "donor- or batch-level split",
    "pinned vocabulary is human",
)
